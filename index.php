		...
		<tr>
			...
			<table border="1" width="100%" height="286" style="border-width: 0px">
				<tr>
					...
					<p align="center"><b><font size="6" color="#FFB415">
					...
					<table border="1" width="100%" style="border-width: 0px" height="187">
						...
						<tr>
							...
							<table border="1" width="100%" style="border-width: 0px">
								<tr>
									<td width="345" style="border-style: none; border-width: medium">
													<input type=submit name=login value="Login" style="border-style:solid; border-width:1px; width: 347; height: 37; color:#0000FF; font-size:14pt; background-color:#0CF1BD"></td>
									<td style="border-style: none; border-width: medium">
									&nbsp;</td>
								</tr>
							</table>
			...
			<div align="center">
				<table border="1" width="94%" style="border-width: 0px">
					<tr>
						...
						<font size="6" color="#0000FF"><b>IRIS </b></font><b>
						<font color="#0000FF" size="6">Stationary</font></b></td>
						<td style="border-style: none; border-width: medium">
						<img border="0" src="images/ban%20hang.png" width="73" height="43" align="right"></td>
					</tr>
				</table>
			</div>
			</td>
