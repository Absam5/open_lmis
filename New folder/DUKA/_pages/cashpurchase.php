...
<table border="1" width="882" style="border-width: 0px" height="193">
	<tr>
		...
		<p align="left">
		<font color="#336699" size="5">&nbsp;</font><font size="5">Cash purchase</font></td>
	</tr>
	<tr>
...
?>
		...
		<input type=submit name=weka value=Save style="width: 112; height: 47; font-size: 14pt; color:#FFFFFF; background-color:#0CF1BD"></td>
	</tr>
	</table>
	</form>
