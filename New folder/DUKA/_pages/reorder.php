...
<table border="1" width="799" style="border-width: 0px">
	<tr>
		<td style="border-style: none; border-width: medium">&nbsp;</td>
		<td style="border-style: none; border-width: medium">&nbsp;</td>
		<td style="border-style: none; border-width: medium" width="67">
...
<table border="1" width="800" height="211" style="border-width: 0px">
	<tr>
		...
		<p align="center">
		<font color="#006699" face="Segoe UI" size="4">&nbsp;Reorder report as at <?php echo $dt ?></font></p>
	...
	<?php
$dt=date('d-M-Y');
$q="select * from stock where quantity<10 and shop='$shop'";
//$r=mysql_query($q);
if((mysql_num_rows(mysql_query($q)))==0) 
{
print"NO REODER FOUND";
}
else
{
$r=mysql_query($q);
