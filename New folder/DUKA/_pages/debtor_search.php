...
@$mteja=$_POST['mteja'];
	...
	if (isset($_POST['veiw']))
{
$q="select sum(cost) from purchase where supplier!='cash' and supplier='$mteja' and shop='$shop'";
$r=mysql_query($q);
if($r)
{
...
print "<table width=\"800\" height=\"50\" border=\"0\" align=\"center\" >
		 <tr >
		 <td colspan=\"7\" align=\"center\"> DEBTOR INFORMATION<hr></td>
		 </tr>
...
$q="select * from credit where customer='$mteja' and shop='$shop'";
//$r=mysql_query($q);
if((mysql_num_rows(mysql_query($q)))==0) 
{
...
$q="select * from sales where customer!='cash' and customer='$mteja' and shop='$shop'";
//$r=mysql_query($q);
if((mysql_num_rows(mysql_query($q)))==0) 
{
print"NO DETAILS FOUND";
...
print "<table width=\"800\" height=\"50\" border=\"0\" align=\"center\" >
		 <tr >
		 <td colspan=\"7\" align=\"center\"> CREDIT SALES REPORT<hr></td>
		 </tr>
