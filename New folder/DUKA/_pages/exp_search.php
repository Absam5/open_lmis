...
$q="select sum(cost) from sales where  date>='$dts' and date<='$dtf'";
$r=mysql_query($q);
if($r)
{
...
<div align="center">
	<table border="1" width="887" height="226" style="border-width: 0px">
		<tr>
...
$q="select * from sales where  date>='$dts' and date<='$dtf'";
//$r=mysql_query($q);
...
print "<table width=\"900\" height=\"50\" border=\"0\" align=\"center\" >
		 <tr >
		 <td colspan=\"7\" align=\"center\"> SALES REPORT FROM $dts TO $dtf<hr></td>
		 </tr>
  ...
  <tr>
    ...
    <td width=\"130\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">PRICE</font></td>
    <td width=\"130\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">COST</font></td>
    <td width=\"150\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">DISCOUNT</font></td>  
<td width=\"150\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">CUSTOMER</font></td>
<td width=\"130\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">DATE</font></td>
...
while($row=mysql_fetch_array($r))
	{
		print "<table width=\"900\" border=\"0\" align=\"center\" >
		 <tr >

  <tr onMouseOver=\"this.bgColor='white'\" onMouseOut=\"this.bgColor='#EBEBEB'\" bgcolor=\"#FF339\">
    <td width=\"200\" bgcolor=\"#FF339\" height=\"30\"><font color=\"black\" >$row[0]</font></td>
    <td width=\"100\" bgcolor=\"#FF339\" height=\"30\"><font color=\"black\" >$row[1]</font></td>
    <td width=\"130\" bgcolor=\"#FF339\" height=\"30\"><font color=\"black\" >$row[2]</font></td>
  <td width=\"130\" bgcolor=\"#FF339\" height=\"30\"><font color=\"black\" >$row[3]</font></td>
  <td width=\"150\" bgcolor=\"#FF339\" height=\"30\"><font color=\"black\" >$row[4]</font></td>
  <td width=\"150\" bgcolor=\"#FF339\" height=\"30\"><font color=\"black\" >$row[5]</font></td>
  <td width=\"130\" bgcolor=\"#FF339\" height=\"30\"><font color=\"black\" >$row[6]</font></td>
...
print "<table width=\"900\" height=\"30\" border=\"0\" align=\"center\" bgcolor=\"#666666\">
		 <tr >

  <tr>
    <td width=\"630\" bgcolor=\"#666666\"><font color=\"#FFFFFF\">TOTAL </font></td>
    
          <td width=\"130\" bgcolor=\"#666666\"><font color=\"#FFFFFF\">: $amount</font></td>
