...
$q="select * from return where date>='$dts' and date<='$dtf'";
//$r=mysql_query($q);
...
print "<table width=\"800\" height=\"50\" border=\"0\" align=\"center\" >
		 <tr >
		 <td colspan=\"7\" align=\"center\"> RETURN INWARD REPORT FROM $dts TO $dtf<hr></td>
		 </tr>
...
while($row=mysql_fetch_array($r))
  ...
  <tr onMouseOver=\"this.bgColor='white'\" onMouseOut=\"this.bgColor='#EBEBEB'\" bgcolor=\"#FF339\">
    <td width=\"150\" bgcolor=\"#EBEBEB\" height=\"30\"><font color=\"black\" >$row[2]</font></td>
  ...
  <td width=\"100\" bgcolor=\"#EBEBEB\" height=\"30\"><font color=\"black\" >$row[0]</font></td>
