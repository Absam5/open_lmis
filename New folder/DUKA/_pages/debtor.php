...
<form method=post><table border="1" width="882" style="border-width: 0px" height="193">
	<tr>
		...
		<p align="left">
		<font color="#336699" size="5">&nbsp;</font><font size="5">Register Debtor</font></td>
		<td style="border-style: none; border-width: medium" width="438" align="center" colspan="2" valign="bottom">
...
$q="SELECT * FROM `debtor` where name='$jina' AND shop='$shop'";
$result=mysql_query($q);
@$count=mysql_num_rows($result);
if(!$count==1)
	{

$query="INSERT INTO `debtor` (`name`,`mobile`,`address`,`shop`)VALUES ('$jina','$simu','$anuwani','$shop')";

@$result=mysql_query($query);
if($result)
	{
	 
print "<font  color=\"#FF9900\" size=\"4\">$jina Registered as debtor</font>";		
}
}
else
{
echo "Debtor's name already exist";
}
}
?>
