...
<table border="1" width="947" style="border-width: 0px" height="193">
	<tr>
		...
		<p align="left">
		<font color="#0CF1BD" size="5">&nbsp;</font><font size="5">Credit Sales</font></td>
	</tr>
	<tr>
...
?>
		...
		<input type=submit name=go value=Sale style="width: 112; height: 47; font-size: 14pt; color:#FFFFFF; background-color:#0CF1BD"></td>
	</tr>
	</table>
	</form>
