...
<table border="1" width="882" style="border-width: 0px" height="193">
	<tr>
		...
		<p align="left">
		<font color="#336699" size="5">&nbsp;&nbsp;Return outward</font></td>
...
$query="INSERT INTO `return` (`customer`,`supplier`,`product`,`quantity`,`date`)VALUES ('$mmiliki','$mteja','$bidhaa','$idadi','$dt')";
...
$up="update creditor set balance='$denijipya' where name='$mteja'";
 @$res=mysql_query($up);
}

print "<font  color=\"#FF9900\" size=\"4\">$idadi units of $bidhaa returned out to $mteja</font>";		
}
}
?>
...
print"<option value=cash> Cash purchase </option>";
	while($row=mysql_fetch_row($r))
	{
