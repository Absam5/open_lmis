...
$key=$_POST['key'];
$dt=date('Y-m-d');
$q="select * from purchase where ((product like '$key%' and shop='$shop') or (supplier='$key' and shop='$shop') or (date='$key' and shop='$shop') ) ";
//$r=mysql_query($q);
										...
										<tr>
											...
											<table border="1" width="900" style="border-width: 0px" bgcolor="#FFFFFF">
												<tr>
													...
													<td style="border-style: none; border-width: medium" ">
													QUANTITY<input type=text name="quantity" value="$quantity" style="height: 24; width: 100" readonly></td>
													...
													<td style="border-style: none; border-width: medium" ">
													SUPPLIER<input type=text name="customer" value="$supplier" style="height: 24; width: 200" readonly></td>
													<td style="border-style: none; border-width: medium" ">
													...
													<td  width="200" align="center" style="border-style: none; border-width: medium" background="bluelinen.jpg"><input name="view" type="submit" value="Delete" / ></td>
												</tr>
											</table>
											</td>
										</tr>
