...
$q="select sum(cost) from purchase where  date>='$dts' and date<='$dtf' and shop='$shop'";
$r=mysql_query($q);
if($r)
{
			...
			<form method=post><table border="1" width="100%" height="42" style="border-width: 0px">
				...
				<tr>
					...
					<td align="center" style="border-style: none; border-width: medium" width="140">
													...
													<input type=submit name=veiw value="Find Report" style="width: 95; height: 37; font-weight:700"></font></td>
				</tr>
			</table></form>
			</td>
		</tr>
...
$q="select * from purchase where  date>='$dts' and date<='$dtf' and shop='$shop'";
//$r=mysql_query($q);
...
print "<table width=\"800\" height=\"50\" border=\"0\" align=\"center\" >
		 <tr >
		 <td colspan=\"7\" align=\"center\">PURCHASE REPORT FROM $dts TO $dtf<hr></td>
		 </tr>

  <tr>
    <td width=\"160\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">ITEM NAME</font></td>
    <td width=\"120\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">QUANTITY</font></td>
    <td width=\"120\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">PRICE</font></td>
    <td width=\"120\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">DATE</font></td>  
<td width=\"160\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">SUPLIER</font></td>
<td width=\"120\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">COST</font></td>
...
while($row=mysql_fetch_array($r))
  ...
  <tr onMouseOver=\"this.bgColor='white'\" onMouseOut=\"this.bgColor='#EBEBEB'\" bgcolor=\"#FF339\">
    <td width=\"160\" bgcolor=\"#EBEBEB\" height=\"30\"><font color=\"black\" >$row[0]</font></td>
    <td width=\"120\" bgcolor=\"#EBEBEB\" height=\"30\"><font color=\"black\" >$row[1]</font></td>
    <td width=\"120\" bgcolor=\"#EBEBEB\" height=\"30\"><font color=\"black\" >$row[2]</font></td>
  <td width=\"120\" bgcolor=\"#EBEBEB\" height=\"30\"><font color=\"black\" >$row[5]</font></td>
    <td width=\"160\" bgcolor=\"#EBEBEB\" height=\"30\"><font color=\"black\" >$row[4]</font></td>
  <td width=\"120\" bgcolor=\"#EBEBEB\" height=\"30\"><font color=\"black\" >$row[3]</font></td>
...
print "<table width=\"800\" height=\"30\" border=\"0\" align=\"center\" bgcolor=\"#666666\">
  ...
  <tr>
    <td width=\"680\" bgcolor=\"#666666\"><font color=\"#FFFFFF\">TOTAL </font></td>
    
          <td width=\"120\" bgcolor=\"#666666\"><font color=\"#FFFFFF\">: $amount</font></td>
