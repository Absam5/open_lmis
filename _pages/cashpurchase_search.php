...
$q="select sum(cost) from purchase where supplier='cash' and date>='$dts' and date<='$dtf'";
$r=mysql_query($q);
if($r)
{
...
$q="select * from purchase where supplier='cash' and date>='$dts' and date<='$dtf'";
//$r=mysql_query($q);
...
print "<table width=\"800\" height=\"50\" border=\"0\" align=\"center\" >
		 <tr >
		 <td colspan=\"7\" align=\"center\">CASH PURCHASE REPORT FROM $dts TO $dtf<hr></td>
		 </tr>
