...
$q="select sum(cost) from sales where customer!='cash' and date>='$dts' and date<='$dtf' and shop='$shop'";
$r=mysql_query($q);
if($r)
{
		...
		<tr>
			...
			<form method=post><table border="1" width="100%" height="42" style="border-width: 0px">
				<tr>
					...
					<b>
					<font size="4" face="Segoe UI" color="#990000">Date from</font></b></td>
					<td width="334" align="center" style="border-style: none; border-width: medium">
					<b>
					<font size="4" face="Segoe UI" color="#990000">Date to</font></b></td>
				...
				<tr>
					...
					<td align="center" style="border-style: none; border-width: medium" width="140">
													...
													<input type=submit name=veiw value="Find Report" style="width: 95; height: 37"></font></td>
				</tr>
			</table></form>
			</td>
		</tr>
...
$q="select * from sales where customer!='cash' and date>='$dts' and date<='$dtf' and shop='$shop'";
//$r=mysql_query($q);
...
print "<table width=\"800\" height=\"50\" border=\"0\" align=\"center\" >
		 <tr >
		 <td colspan=\"7\" align=\"center\"> CREDIT SALES REPORT FROM $dts TO $dtf<hr></td>
		 </tr>

  <tr>
    <td width=\"150\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">ITEM NAME</font></td>
    <td width=\"100\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">QUANTITY</font></td>
    <td width=\"100\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">PRICE</font></td>
    <td width=\"110\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">DISCOUNT</font></td>
    <td width=\"100\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">DATE</font></td>  
<td width=\"150\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">CUSTOMER</font></td>
<td width=\"100\" bgcolor=\"#666666\" height=\"30\"><font color=\"#FFFFFF\">COST</font></td>
...
while($row=mysql_fetch_array($r))
  ...
  <tr onMouseOver=\"this.bgColor='white'\" onMouseOut=\"this.bgColor='#EBEBEB'\" bgcolor=\"#FF339\">
    <td width=\"150\" bgcolor=\"#EBEBEB\" height=\"30\"><font color=\"black\" >$row[0]</font></td>
    <td width=\"100\" bgcolor=\"#EBEBEB\" height=\"30\"><font color=\"black\" >$row[1]</font></td>
    <td width=\"100\" bgcolor=\"#EBEBEB\" height=\"30\"><font color=\"black\" >$row[2]</font></td>
  <td width=\"100\" bgcolor=\"#EBEBEB\" height=\"30\"><font color=\"black\" >$row[4]</font></td>
  <td width=\"100\" bgcolor=\"#EBEBEB\" height=\"30\"><font color=\"black\" >$row[6]</font></td>
  <td width=\"150\" bgcolor=\"#EBEBEB\" height=\"30\"><font color=\"black\" >$row[5]</font></td>
  <td width=\"100\" bgcolor=\"#EBEBEB\" height=\"30\"><font color=\"black\" >$row[3]</font></td>
