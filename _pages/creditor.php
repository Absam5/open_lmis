...
<form method=post><table border="1" width="882" style="border-width: 0px" height="193">
	<tr>
		...
		<p align="left">
		<b>
		<font color="#990000" size="5">&nbsp;Register creditor</font></b></td>
		<td style="border-style: none; border-width: medium" width="438" align="center" colspan="2" valign="bottom">
...
?>
	...
	<tr>
		...
		<input type=submit name=sajili value=Register style="width: 112; height: 47; font-size: 14pt; color:#990000; background-color:#0CF1BD; font-weight:700"></td>
	</tr>
	</table></form>
