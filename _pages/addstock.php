...
<table border="1" width="882" style="border-width: 0px" height="98">
	<tr>
		...
		<p>
		<font color="#336699" size="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</font><b><font size="5" face="Segoe UI" color="#990000">Register new stock</font></b></td>
		<td style="border-style: none; border-width: medium" width="438" align="center" colspan="2" valign="bottom" height="32">
		&nbsp;
...
?>
	...
	<tr>
		...
		<input type=submit name=sajili value=Register style="width: 112; height: 47; font-size: 14pt; color:#990000; background-color:#0CF1BD"></td>
	</tr>
	</table>
	</form>
