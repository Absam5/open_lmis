...
<div align="center">
<form method=post action=csalesprocess.php>
<table border="1" width="947" style="border-width: 0px" height="193">
	<tr>
		...
		<p align="left">
		<font color="#0CF1BD" size="5">&nbsp;</font><b><font size="5" color="#990000">Credit Sales</font></b></td>
	</tr>
	<tr>
...
?>
		...
		<input type=submit name=go value=Sale style="width: 112; height: 47; font-size: 14pt; color:#990000; background-color:#0CF1BD; font-weight:700"></td>
	</tr>
	</table>
	</form>
