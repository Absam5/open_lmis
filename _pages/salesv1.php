...
<table border="1" width="798" style="border-width: 0px">
	<tr>
		<td style="border-style: none; border-width: medium" bgcolor="#0CF1BD">&nbsp;</td>
		<td style="border-style: none; border-width: medium" bgcolor="#0CF1BD">&nbsp;</td>
		<td style="border-style: none; border-width: medium" width="59" bgcolor="#0CF1BD">
													
													
													
													&nbsp;</td>
		<td style="border-style: none; border-width: medium" width="57" bgcolor="#0CF1BD">
													
													
													
													<p align="center">
													<a href="home.php">
													<img border="0" src="../images/cl.PNG" width="34" height="19"></a></td>
		<td style="border-style: none; border-width: medium" width="6" bgcolor="#0CF1BD">
...
<table border="1" width="800" height="211" style="border-width: 0px">
	<tr>
		...
		<p align="center">
		<font color="#006699" face="Segoe UI" size="4">&nbsp;</font><font color="#990000" face="Segoe UI" size="4"><b>Daily sales report</b></font></p>
