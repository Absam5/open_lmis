...
<div align="center">
<form method=post action=purchaseprocess.php>
<table border="1" width="882" style="border-width: 0px" height="193">
	<tr>
		...
		<p align="left">
		<font color="#336699" size="5">&nbsp;</font><font size="5" color="#990000">Cash purchase</font></td>
	</tr>
	<tr>
...
?>
		...
		<input type=submit name=weka value=Save style="width: 112; height: 47; font-size: 14pt; color:#990000; background-color:#0CF1BD"></td>
	</tr>
	</table>
	</form>
